function plotActivityResults(mdl,rawSensorDataTest,humanActivityTest,testActivity,delay)
...
humanActivityTest.activity = testActivity;
try
    for ii = 600:1000
        
        activity = mdl.predictFcn(humanActivityTest(ii,1:end-1));
