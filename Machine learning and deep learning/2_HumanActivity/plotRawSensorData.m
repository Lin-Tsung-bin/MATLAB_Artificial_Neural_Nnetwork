function plotRawSensorData(sensorData, activity, n_obs)

% Extract info. from table
rawSensor1 = sensorData.total_acc_x_train;
rawSensor2 = sensorData.total_acc_y_train;
rawSensor3 = sensorData.total_acc_z_train;
...
title(ax(1),'total_acc_x_train','Interpreter','none')
title(ax(2),'total_acc_y_train','Interpreter','none')
title(ax(3),'total_acc_z_train','Interpreter','none')
